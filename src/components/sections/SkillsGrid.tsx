...
const accentStyles = {
  blue: {
    ...
    glow: 'hover:shadow-[0_0_0_1px_rgba(79,142,247,0.12),0_20px_44px_rgba(79,142,247,0.09),0_18px_40px_rgba(0,0,0,0.15)]',
  },
  purple: {
    icon: 'bg-[var(--accent2-glow)] border border-accent2/20',
    title: 'text-accent2',
    border: 'hover:border-accent2/30',
    glow: 'hover:shadow-[0_0_0_1px_rgba(124,92,252,0.12),0_20px_44px_rgba(124,92,252,0.09),0_18px_40px_rgba(0,0,0,0.15)]',
  },
  orange: {
    icon: 'bg-orange-500/10 border border-orange-500/20',
    title: 'text-orange-400',
    border: 'hover:border-orange-500/30',
    glow: 'hover:shadow-[0_0_0_1px_rgba(249,115,22,0.12),0_20px_44px_rgba(249,115,22,0.08),0_18px_40px_rgba(0,0,0,0.15)]',
  },
  teal: {
    icon: 'bg-[var(--accent2-glow)] border border-accent2/20',
    title: 'text-accent2',
    border: 'hover:border-accent2/30',
    glow: 'hover:shadow-[0_0_0_1px_rgba(100,116,139,0.12),0_20px_44px_rgba(100,116,139,0.08),0_18px_40px_rgba(0,0,0,0.15)]',
  },
  pink: {
